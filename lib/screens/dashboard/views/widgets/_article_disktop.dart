...
class _ArticleDesktop extends StatefulWidget {
  const _ArticleDesktop({Key? key}) : super(key: key);

  @override
  State<_ArticleDesktop> createState() => _ArticleDesktopState();
}

class _ArticleDesktopState extends State<_ArticleDesktop> {
